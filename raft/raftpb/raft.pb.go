...
type Entry struct {
	...
	// Entry中Raft log中的位置索引，有了Term和Index就可以确定 log entry的标识了
	Index            uint64    `protobuf:"varint,3,opt,name=Index" json:"Index"`
	// entry类型，目前有三种类型：EntryNormal EntryConfChange EntryConfChangeV2
	// EntryNormaln表示普通的数据操作 EntryConfChange表示集群的变更操作
...
type Message struct {
	...
	// 消息的目标节点 ID，在集群中每个节点都有一个唯一的id作为标识
